                                        ...
                                        foreach ($results as $result) {               ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <img src="bookimg/<?php echo htmlentities($result->bookImage); ?>" width="100"><br>
                                                    <a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid); ?>" class="clickable_link">
                                                        Change Book Image
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control tall" name="category" required="required">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control tall" name="author" required="required">
