            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="navbar-collapse collapse ">
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" id="cat" data-toggle="dropdown"> Categories <i class="fa fa-angle-down"></i></a>
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" id="auth" data-toggle="dropdown"> Authors <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" id="bk" data-toggle="dropdown"> Books <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" id="ib" data-toggle="dropdown"> Issue Books <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                        ...
                        <li><a href="reg-students.php" id="rs">Reg Students</a></li>

                        <li><a href="change-password.php" id="cp">Change Password</a></li>
                    </ul>
                </div>
            </div>
